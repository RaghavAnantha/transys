	...
	private void drawToolbar() throws JspException {
		...
		try {
			...
			if (insertable) {
				...
				//if (authenticationService.hasUserPermission(user, url))
					objOut.write("<a href=\""+pageContext.getAttribute("ctx")+"/"+urlContext+"/create.do\" data-remote=\"false\" data-toggle=\"modal\" data-target=\"#myModal\"><img src=\""+pageContext.getAttribute("resourceCtx")+"/images/add.png\" border=\"0\" title=\"Add\" class=\"toolbarButton\"/></a>&nbsp;");
			}
			if (multipleDelete) {
