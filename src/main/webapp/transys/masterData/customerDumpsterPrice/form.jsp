...
function processCustomerDumpsterPriceForm() {
	if (validateCustomerDumpsterPriceForm()) {
		var customerDumpsterPriceForm = $("#customerDumpsterPriceForm");
		customerDumpsterPriceForm.submit();
		return true;
	} else {
		return false;
	}
...
function validateCustomerDumpsterPriceForm() {
	var missingData = validateCustomerDumpsterPriceMissingData();
	if (missingData != "") {
	...
	var formatValidation = validateCustomerDumpsterPriceDataFormat();
	if (formatValidation != "") {
...
function validateCustomerDumpsterPriceMissingData() {
	var missingData = "";
...
function validateCustomerDumpsterPriceDataFormat() {
	var validationMsg = "";
...
<form:form action="save.do" name="customerDumpsterPriceForm" commandName="modelObject" method="post" id="customerDumpsterPriceForm">
	<form:hidden path="id" id="id" />
	<jsp:include page="/common/messages.jsp">
		<jsp:param name="msgCtx" value="manageCustomerDumpsterPrice" />
	</jsp:include>
	<table id="form-table" class="table">
		...
		<tr>
			<td>&nbsp;</td>
			<td colspan="2">
				<input type="button" id="create" onclick="return processCustomerDumpsterPriceForm();" value="Save"
