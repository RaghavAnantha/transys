...
<form:form name="manageInvoiceServiceForm" id="manageInvoiceServiceForm" class="tab-color">
	<transys:datatable urlContext="invoice" expandable="true" expandableQualifier="invoice" deletable="false"
		...
		<transys:imagecolumn width="90px" headerText="Paymnt. Stmt." linkUrl="${ctx}/invoice/downloadInvoicePaymentAll.do?invoiceId={id}&type=pdf" imageSrc="fas fa-receipt" HAlign="center" title="Paymnt. Stmt."/>
	</transys:datatable>
