...
<form:form name="invoicePaymentServiceForm" id="invoicePaymentServiceForm" class="tab-color">
	<transys:datatable urlContext="invoice" expandable="true" expandableQualifier="invoicePayment" deletable="false"
		...
		<transys:imagecolumn width="90px" headerText="Paymnt. Stmt." linkUrl="${ctx}/invoice/downloadInvoicePaymentAll.do?invoicePaymentId={id}&type=pdf" imageSrc="fas fa-receipt" HAlign="center" title="All Paymnt. Stmt."/>
