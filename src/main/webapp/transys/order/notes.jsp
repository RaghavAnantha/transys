...
<form:form name="orderNotesDatatable" id="orderNotesDatatable" class="tab-color">
	<transys:datatable urlContext="order" baseObjects="${notesList}"
		...
		<transys:textcolumn headerText="Entered By" dataField="createdBy" width="125px" />
		<transys:textcolumn headerText="Date/Time" dataField="createdAt" dataFormat="MM/dd/yyy" width="10px"/>
