...
<form:form action="list.do" method="get" name="publicMaterialIntakeSearchForm">
	<table id="form-table" class="table">
		<tr>
			...
			<td>
				<select class="flat form-control form-control-ext input-sm" id="materialType.materialCategory" name="materialType.materialCategory" style="width: 175px !important" onChange="return populateMaterialTypes();">
...
<form:form name="materialIntakeServiceForm" id="materialIntakeServiceForm" class="tab-color">
	<transys:datatable urlContext="publicMaterialIntake" deletable="true"
		...
		exportPdf="true" exportXls="true" dataQualifier="materialIntake">
	...
	<%session.setAttribute("materialIntakeColumnPropertyList", pageContext.getAttribute("columnPropertyList"));%>
</form:form>
