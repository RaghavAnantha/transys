...
CREATE TABLE `permit` (
  ...
  KEY `permitDeliveryAddressReff_idx` (`deliveryAddress`),
  ...
  CONSTRAINT `permitDeliveryAddressRef` FOREIGN KEY (`deliveryAddress`) REFERENCES `deliveryAddress` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
